...
class AutocompleteServiceImplTest {
    ...
    void whenAutocompleteParametersArePresent_upstreamUrlIsProperlyBuilt() {
        String expectedURI = "https://autosuggest.search.hereapi.com/v1/autosuggest?q=747+E+Bea&at=40.599830,-97.120535&in=countryCode:USA&apiKey=null";
        ...
        autocompleteService = new AutocompleteServiceImpl(webClientBuilder);
